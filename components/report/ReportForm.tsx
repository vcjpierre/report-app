...
type ReportType = "EMERGENCIA" | "NO_EMERGENCIA";
...
export function ReportForm({ onComplete }: ReportFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(result.error || "Falló la creación del reporte");	
      }
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          type="button"
          onClick={() =>
            setFormData((prev) => ({ ...prev, incidentType: "EMERGENCIA" }))
          }
          className={`p-6 rounded-2xl border-2 transition-all duration-200 ${
            formData.incidentType === "EMERGENCIA"
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="font-medium text-red-500">Emergencia</span>
        ...
        <button
          type="button"
          onClick={() =>
            setFormData((prev) => ({ ...prev, incidentType: "NO_EMERGENCIA" }))
          }
          className={`p-6 rounded-2xl border-2 transition-all duration-200 ${
            formData.incidentType === "NO_EMERGENCIA"
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="font-medium text-orange-500">No urgente</span>
            <span className="text-xs text-zinc-400">Informe general</span>
          </div>
        </button>
      </div>
        ...
        >
          {image ? (
            <div className="space-y-4">
              ...
              <p className="text-sm text-zinc-400">Haz clic para cambiar la imagen</p>
            </div>
          ) : (
            <div className="space-y-4">
              <svg
              ...
              <p className="text-sm text-zinc-400">
                  Suelte una imagen aquí o haga clic para cargarla
              </p>
            </div>
          )}
        </label>
